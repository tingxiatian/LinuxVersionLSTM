...
def main():
    ...
    '''
    with open("local_used_lstm_crf/config_dict.pkl", "rb") as f:
    ...
    with codecs.open("local_used_lstm_crf/new_config.yml", "w", encoding="utf-8") as f:
        yaml.dump(config, f)
    '''
    with open("local_used_lstm_crf/config_dict.pkl", "wb") as f:
